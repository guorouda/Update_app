...
public class UnZip
{
    ...
    private static final String INPUT_ZIP_FILE = "C:\\apache-tomcat-7.0.35\\webapps\\snaker-web-1.0.1.war";
    private static final String OUTPUT_FOLDER = "F:\\tmp\\temp";
...
//    	FileUtils.deleteDirectory(new File("F:\\tmp\\temp"));
